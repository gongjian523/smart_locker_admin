...
namespace CFLMedCab.Http.Bll
{
	...
	public class UserLoginBll : BaseBll<UserLoginBll>
	{
		...
		/// <param name="param">请求参数</param>
		/// <returns></returns>
		public BasePostData<VeinMatch> VeinmatchLogin(VeinmatchPostParam param)
		{
            System.Diagnostics.Debug.WriteLine("VeinmatchLogin: " + param.regfeature);
            return HttpHelper.GetInstance().Post<VeinMatch, VeinmatchPostParam>(HttpHelper.GetVeinmatchLoginUrl(), param);
		}
