...
namespace UboConfigTool.Infrastructure.Models
{
    ...
    public class UBOWithUsbInfo : IEntity
    {
        public UBOWithUsbInfo(string uboName, string grpName, UBOConnectionType connectStus, int id, USB_Access_Role permission)
        {
            UBOName = uboName;
            GroupName = grpName;
            ConnectStatus = connectStus;
            UBOId = id;
        ...
        public UBOConnectionType ConnectStatus { get; set; }

        public int UBOId { get; set; }

        public USB_Access_Role Permission {get; set;}
